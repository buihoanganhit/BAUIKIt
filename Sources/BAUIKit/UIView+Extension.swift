...
//
//    @discardableResult mutating func setTop(constant: CGFloat) -> baseView
//    @discardableResult mutating func setSafeAreaTop(constant: CGFloat) -> baseView
//    @discardableResult mutating func setBottom(constant: CGFloat) -> baseView
//    @discardableResult mutating func setSafeAreaBottom(constant: CGFloat) -> baseView
//    @discardableResult mutating func setLeading(constant: CGFloat) -> baseView
//    @discardableResult mutating func setTrailing(constant: CGFloat) -> baseView
//    @discardableResult mutating func setCenterX(constant: CGFloat) -> baseView
//    @discardableResult mutating func setCenterY(constant: CGFloat) -> baseView
//    @discardableResult mutating func setFullConstraint(constant: CGFloat) -> baseView
//    @discardableResult mutating func setSafeAreaFullConstraint(constant: CGFloat) -> baseView
//    @discardableResult mutating func setWidth(constant: CGFloat) -> baseView
//    @discardableResult mutating func setHeight(constant: CGFloat) -> baseView
//    @discardableResult mutating func setWidthEqualHeight(multiplier: CGFloat) -> baseView
//    @discardableResult mutating func setHeightEqualWidth(multiplier: CGFloat) -> baseView
//    @discardableResult mutating func setTop(underView view: UIView ,constant: CGFloat) -> baseView
//    @discardableResult mutating func setBottom(aboveView view: UIView ,constant: CGFloat) -> baseView
//    @discardableResult mutating func setLeading(afterView view: UIView ,constant: CGFloat) -> baseView
//    @discardableResult mutating func setTrailing(beforeView view: UIView ,constant: CGFloat) -> baseView
//    @discardableResult mutating func setCenterX(equalTo view: UIView ,constant: CGFloat) -> baseView
//    @discardableResult mutating func setCenterY(equalTo view: UIView ,constant: CGFloat) -> baseView
//    @discardableResult mutating func setWidth(otherView: UIView?, multiplier: CGFloat) -> baseView
//    @discardableResult mutating func setHeight(_ otherView: UIView?, multiplier: CGFloat) -> baseView
//
...
//    public var topConstraintLayout: NSLayoutConstraint? {
//        get { return self.topConstraintLayout }
//        set { self.topConstraintLayout?.constant = newValue?.constant ?? 0.0 }
//    }
//
//    public var leadingConstraintLayout: NSLayoutConstraint? {
//        get { nil }
...
//extension BaseUIViewPresent where baseView: UIView {
//    @discardableResult public func setTop(constant: CGFloat = 0) -> Self {
//        guard let superView = baseView.superview else {return self}
//        self.topConstraintLayout = baseView.topAnchor.constraint(equalTo: superView.topAnchor, constant: constant)
